        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="flex items-center text-gray-600 mb-4">
              ...
              <span>
                Home Country: <strong>{currentMatch.homeCountry}</strong>
              </span>
            </div>
            ...
            <div className="flex items-center text-gray-600 mb-4">
              ...
              <span>
                Living in: <strong>{currentMatch.currentProvince}, {currentMatch.currentCountry}</strong>
              </span>
            </div>
            ...
            <div className="flex gap-4">
              <button
                onClick={handlePass}
                className="flex-1 bg-gray-200 text-gray-700 py-4 rounded-xl font-semibold hover:bg-gray-300 transition flex items-center justify-center"
              >
              ...
              <button
                onClick={handleMeet}
                className="flex-1 bg-indigo-600 text-white py-4 rounded-xl font-semibold hover:bg-indigo-700 transition flex items-center justify-center"
              >
                <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
